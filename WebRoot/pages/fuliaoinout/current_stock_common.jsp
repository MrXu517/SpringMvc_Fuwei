...
<html>
	<head>
		<base href="<%=basePath%>">
		<title>通用库位当前库存列表 -- 桐庐富伟针织厂</title>
		<meta charset="utf-8">
							...
							<div class="col-md-12 tablewidget">
								...
								<div clas="navbar navbar-default">
									...
									<ul class="pagination">
										<li>
											<a
												href="fuliao_workspace/current_stock_common?locationNumber=<%=locationNumber_str%>&page=1">«</a>
										</li>
										...
										<li class="">
											<a
												href="fuliao_workspace/current_stock_common?locationNumber=<%=locationNumber_str%>&page=<%=pager.getPageNo() - 1%>">上一页
										...
										<li class="active">
											<a
												href="fuliao_workspace/current_stock_common?locationNumber=<%=locationNumber_str%>&page=<%=pager.getPageNo()%>"><%=pager.getPageNo()%>/<%=pager.getTotalPage()%>，共<%=pager.getTotalCount()%>条<span
										...
										<li class="">
											<a
												href="fuliao_workspace/current_stock_common?locationNumber=<%=locationNumber_str%>&page=<%=pager.getPageNo() + 1%>">下一页
												<span class="sr-only"></span> </a>
										</li>
										<%
											} else {
										...
										<li>
											<a
												href="fuliao_workspace/current_stock_common?locationNumber=<%=locationNumber_str%>&page=<%=pager.getTotalPage()%>">»</a>
										</li>
									</ul>
