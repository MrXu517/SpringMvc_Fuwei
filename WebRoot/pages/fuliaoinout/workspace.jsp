					...
					<div id="tab">
						...
						<div class="tab-content auto_height">
							<div class="tab-pane active" id="store_in">
								<iframe id="store_inIframe" name="store_inIframe" border="0" furl="fuliaoin/index" > </iframe>

							</div>
							<div class="tab-pane" id="store_out">
								<iframe id="store_outIframe" name="store_outIframe" border="0" furl="fuliaoout/index" > </iframe>
							</div>
							<div class="tab-pane" id="store_return">
								<iframe id="store_returnIframe" name="store_returnIframe" border="0" furl="fuliaoreturn/index" > </iframe>
							</div>
							<div class="tab-pane" id="current_stock">
								<iframe id="current_stockIframe" name="current_stockIframe" border="0" furl="fuliao_workspace/current_stock" > </iframe>
							</div>
						</div>
					</div>
