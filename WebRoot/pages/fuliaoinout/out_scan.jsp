...
<html>
	...
	<body>
			...
			<div id="main">
				...
				<div class="body">
					<div class="container-fluid producingWidget">
						<div class="row">
							<form action="fuliaoout/add">
								<div class="form-group col-md-12">
									<label for="fuliaoNoticeNumber" class="col-sm-3 control-label">
										辅料出库通知单号
									</label>
									<div class="input-group col-sm-9">
										<input type="text" class="form-control" name="fuliaoNoticeNumber" id="fuliaoNoticeNumber" />
		...
		<script type="text/javascript">
			...
			$("#fuliaoNoticeNumber").focus();
			
			$("form").submit(function(){
				$("#fuliaoNoticeNumber").focus();
				$("#fuliaoNoticeNumber").select();
				return true;
			});
		</script>
	</body>
