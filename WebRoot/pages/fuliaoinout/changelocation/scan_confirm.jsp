...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	Fuliao object = (Fuliao)request.getAttribute("fuliao");
...
<html>
	<head>
		...
		<script src="js/fuliaoinout/changelocation/scan_confirm.js" type="text/javascript"></script>
				...
				<div class="body">
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-12">
								<form class="saveform">
									<input type="hidden" name="fuliaoId" value="<%=object.getId() %>" />
													...
													<td colspan="2">
														<table class="table table-responsive table-bordered">
															<tbody>
																...
																<tr>
																	<td>
																		<div class="name">公司订单号：</div><span class="value"><%=object.getCompany_orderNumber()%></span>
																	</td>
																	<td>
																		<div class="name">公司货号：</div><span class="value"><%=object.getCompany_productNumber()%></span>
																	</td>
																</tr>
																
																<tr>
																	<td>
																		<div class="name">颜色：</div><span class="value"><%=object.getColor()%></span>
																	</td>
																	<td>
																		<div class="name">尺码：</div><span class="value"><%=object.getSize()%></span>
																	</td>
																</tr>
																<tr>
																	<td>
																		<div class="name">批次：</div><span class="value"><%=object.getBatch()%></span>
																	</td>
																	<td>
																		<div class="name">国家：</div><span class="value"><%=object.getCountry()%></span>
																	</td>
																	
																</tr>
																<tr>
																	<td>
																		<div class="name">库位容量：</div><span class="value"><%=object.getLocationSizeString()%></span>
																	</td>
																	<td>
																		<div class="name">备注：</div><span class="value"><%=object.getMemo()%></span>
																	</td>
