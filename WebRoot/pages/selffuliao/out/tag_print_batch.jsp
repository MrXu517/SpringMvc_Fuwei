...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	//辅料出库单
	List<SelfFuliaoOut> result = (List<SelfFuliaoOut>) request.getAttribute("result");
	if(result == null){
		result = new ArrayList<SelfFuliaoOut>();
	}
%>
<!DOCTYPE html>
<html>
	<head>
		<base href="<%=basePath%>">
		<title>批量打印自购辅料标签 -- 桐庐富伟针织厂</title>
		<meta charset="utf-8">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 tablewidget">
					<%
					for(SelfFuliaoOut object : result){
						String employee_name = SystemCache.getEmployeeName(object.getCharge_employee())  ;//跟单人
						List<SelfFuliaoOutDetail> detaillist = object == null ? new ArrayList<SelfFuliaoOutDetail>() :object.getDetaillist();
