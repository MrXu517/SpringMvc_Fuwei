...
<html>
	...
	<body>
			...
			<div id="main">
				...
				<div class="body">
					<div class="container-fluid producingWidget">
						<div class="row">
							<form action="selffuliaoout/add">
								<div class="form-group col-md-12">
									<label for="fuliaoPurchaseOrderNumber" class="col-sm-3 control-label">
										辅料采购单号
									</label>
									<div class="input-group col-sm-9">
										<input type="text" class="form-control" name="fuliaoPurchaseOrderNumber" id="fuliaoPurchaseOrderNumber" />
		...
		<script type="text/javascript">
			...
			$("#fuliaoPurchaseOrderNumber").focus();
			
			$("form").submit(function(){
				$("#fuliaoPurchaseOrderNumber").focus();
				$("#fuliaoPurchaseOrderNumber").select();
				return true;
			});
		</script>
	</body>
