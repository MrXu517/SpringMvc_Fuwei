...
<html>
	<head>
		...
		<script src="js/half_store_in_out/add_in.js" type="text/javascript"></script>
		<style type="text/css">
.saveform .form-group {
	width: 250px;
}
			...
			<div id="main">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li>
							<a href="order/detail/<%=planOrder.getOrderId()%>">订单详情</a>
						</li>
						<li>
												...
												<tr class="tr" data='<%=SerializeTool.serialize(item)%>'>
													...
													<td>
														<input class="quantity form-control require positive_int value"
															...
															placeholder="小于等于<%=(Integer)item.get("not_in_quantity") + (Integer)item.get("quantity")%>的数量">
													</td>
												</tr>
												<%
													}
