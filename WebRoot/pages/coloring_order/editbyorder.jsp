			...
			<div id="main">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li>
							<a href="order/tablelist?orderId=<%=coloringOrder.getOrderId()%>&tab=coloringorder">订单表格</a>
						</li>
						<li class="active">
							编辑染色单
						</li>
						...
						<div class="row">
							<form class="saveform">
								...
								<input type="hidden" id="orderId" name="orderId"
									value="<%=coloringOrder.getOrderId()%>" class="require" />
								<button type="submit"
												...
												<td>
													...
													<div class="form-group">
														...
														<select disabled name="charge_employee" id="charge_employee"
																	class="form-control">
																	<option value="<%=coloringOrder.getCharge_employee()%>" selected><%=SystemCache.getEmployeeName(coloringOrder.getCharge_employee())%></option>
																</select>
													</div>
														...
														<tr>
															...
															<td class="center">
																<input readonly type="text" name="company_productNumber"
																	...
																	value="<%=coloringOrder.getCompany_productNumber() == null ? "" : coloringOrder
