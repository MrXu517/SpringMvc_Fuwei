...
<html>
	<head>
		...
		<script src="js/util/pantongcolor/import.js" type="text/javascript"></script>
							...
							<div class="col-md-12 formwidget">
								<fieldset>
									...
									<form class="form-horizontal form" role="form"
										enctype="multipart/form-data" action="pantongcolor/import"
										method="post">
	...
	/*设置当前选中的页*/
	var $a = $("#left li a[href='pantongcolor/import']");
