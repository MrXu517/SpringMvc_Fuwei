...
<%@page import="com.fuwei.entity.producesystem.plan.GongxuLine"%>
<%
	String path = request.getContextPath();
	String basePath = request.getScheme() + "://"
			+ request.getServerName() + ":" + request.getServerPort()
			+ path + "/";
	List<GongxuLine> linelist = (List<GongxuLine>)request.getAttribute("linelist");
%>
<!DOCTYPE html>
<html>
	<head>
		<base href="<%=basePath%>">
		<title>工序流水线 -- 桐庐富伟针织厂</title>
		<meta charset="utf-8">
		...
		<script src="js/systeminfo/material.js" type="text/javascript"></script>
