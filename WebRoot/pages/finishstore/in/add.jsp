							...
							<div class="col-md-12">
								<form class="saveform">
									...
									<div class="col-md-12 tablewidget">
										...
										<p class="alert alert-info">提示：只能选择一张装箱单进行入库</p>
										...
										<table id="mainTb"
											...
											<tbody>
												...
												<tr class="tr EmptyTr disable" data='<%=json.toString()%>'>
													<td><input type="checkbox" name="checked" class="checkBtn" disabled/></td>
													<%if(item.getCol1_id()!=null){ %>
										<td>
										...
										<%} %>
													...
													<td><%=actualIn_cartons%>
														<%if(actualIn_cartons == detail.getCartons()){ %>
														<span class="label label-warning">已满</span>
														<%} %>
														<%if(actualIn_cartons > detail.getCartons()){ %>
														<span class="label label-danger">已超</span>
														<%} %>
														</td>
													<td class="quantity">
														0
