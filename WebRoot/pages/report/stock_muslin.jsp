...
<%
	...
	HashMap<Integer,HashMap<Integer,Double> > result = (HashMap<Integer,HashMap<Integer,Double> >)request.getAttribute("result");
...
<html>
									...
									<tbody>
										<%
											...
											for (Integer key : result.keySet()) {
												for (Integer key_m : result.get(key).keySet()) {
										%>
										<tr>
											<td><%=++i%></td>
											<td><%=SystemCache.getFactoryName(key)%></td>
											<td><%=SystemCache.getMaterialName(key_m)%></td>
	...
	/*设置当前选中的页*/
	var $a = $("#left li a[href='report/stock_muslin']");
