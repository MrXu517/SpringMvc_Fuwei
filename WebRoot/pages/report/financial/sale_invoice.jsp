...
<input name="un_received" type="checkbox" value="1" style="margin-left:10px;">  未收<%} %>
											...
											<table class="table table-responsive">
												...
												<tbody>
													...
													<%}else{ %>
												</tbody><tfoot><tr><td></td><td>合计</td><td></td><td><%=String.format("%.2f",total_amount)%></td><td><%=String.format("%.2f",total_matched_amout)%></td><td><%=String.format("%.2f",total_unmatched_amount) %></td><td></td><td></td><td></td><td></td><td></td></tr></tfoot>
											<%} %>
											</table>
										</div>
									</div>
