...
<input name="un_paid" type="checkbox" value="1" style="margin-left:10px;">  未付<%} %>
													...
													<li>
														<a
															href="report/financial/purchase_invoice?company_id=<%=company_str %>&subject_id=<%=subject_str %>&un_paid=<%=un_paid_str %>&bank_id=<%=bank_str%>&start_time=<%=start_time_str%>&end_time=<%=end_time_str%>&page=1">«</a>
													</li>
													...
													<li class="">
														<a
															href="report/financial/purchase_invoice?company_id=<%=company_str %>&subject_id=<%=subject_str %>&un_paid=<%=un_paid_str %>&bank_id=<%=bank_str%>&start_time=<%=start_time_str%>&end_time=<%=end_time_str%>&page=<%=pager.getPageNo() - 1%>">上一页
													...
													<li class="active">
														<a
															href="report/financial/purchase_invoice?company_id=<%=company_str %>&subject_id=<%=subject_str %>&un_paid=<%=un_paid_str %>&bank_id=<%=bank_str%>&start_time=<%=start_time_str%>&end_time=<%=end_time_str%>&page=<%=pager.getPageNo()%>"><%=pager.getPageNo()%>/<%=pager.getTotalPage()%>，共<%=pager.getTotalCount()%>条<span
													...
													<li class="">
														<a
															href="report/financial/purchase_invoice?company_id=<%=company_str %>&subject_id=<%=subject_str %>&un_paid=<%=un_paid_str %>&bank_id=<%=bank_str%>&start_time=<%=start_time_str%>&end_time=<%=end_time_str%>&page=<%=pager.getPageNo() + 1%>">下一页
															<span class="sr-only"></span> </a>
													</li>
													<%
														} else {
													...
													<li>
														<a
															href="report/financial/purchase_invoice?company_id=<%=company_str %>&subject_id=<%=subject_str %>&un_paid=<%=un_paid_str %>&bank_id=<%=bank_str%>&start_time=<%=start_time_str%>&end_time=<%=end_time_str%>&page=<%=pager.getTotalPage()%>">»</a>
													</li>
												</ul>
												</form>
