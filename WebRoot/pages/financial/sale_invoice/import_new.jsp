...
<html>
	<head>
		...
		<script src="js/financial/sale_invoice/import_new.js" type="text/javascript"></script>
							...
							<div class="col-md-12 formwidget">
								<fieldset>
									...
									<form class="form-horizontal form" role="form"
										enctype="multipart/form-data" action="sale_invoice/import_new"
										method="post">

										<div class="col-md-12">
											<div class="form-group">
												<a href="sale_invoice/import_download" class="btn btn-primary">下载模板</a>
											</div>
											<div class="form-group">
