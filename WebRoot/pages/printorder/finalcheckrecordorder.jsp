...
<%
	...
	List<PlanOrderDetail> DetailList = planOrder == null ? new ArrayList<PlanOrderDetail>()
				...
				<div class="col-md-12 tablewidget">
					<table class="table noborder">
						<caption id="tablename">
							桐庐富伟针织厂成品检验记录单<div table_id="<%=order.getOrderNumber() %>" class="id_barcode"></div>
						</caption>
					...
					<p class="pull-right auto_bottom">
						<span id="created_user">制单人：<%=SystemCache.getUserName(planOrder.getCreated_user()) %></span>
						<span id="date"> 日期：<%=DateTool.formatDateYMD(DateTool.getYanDate(planOrder.getCreated_at())) %></span>
					</p>
