...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	List<FuliaoType> fuliaotypelist = (List<FuliaoType>) request
			.getAttribute("fuliaotypelist");
%>
<!DOCTYPE html>
<html>
	<head>
		...
		<script src="js/systeminfo/fuliaotype.js" type="text/javascript"></script>
									...
									<div class="panel panel-primary">
										...
										<table class="table table-responsive">
											...
											<tbody>
												<%
													int g_i = 1;
													for (FuliaoType temp : fuliaotypelist) {
												%>
												<tr>
													<td><%=g_i%></td>
													<td><%=temp.getName()%></td>
