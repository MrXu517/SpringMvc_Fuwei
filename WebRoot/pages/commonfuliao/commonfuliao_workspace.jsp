...
<html>
				...
				<div class="body">
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-12 btnWidget">
								...
								<a href="fuliaoin/scan" type="button" class="btn btn-warning"><i class="fa fa-sign-in fa-lg"></i>通用辅料入库</a>
								<a href="fuliaoout/scan" type="button" class="btn btn-danger"><i class="fa fa-sign-out fa-lg"></i>通用辅料出库</a>
					...
					<div id="tab">
						...
						<ul class="nav nav-tabs" role="tablist">
							<li class="active">
								<a href="#store_in" role="tab" data-toggle="tab">通用辅料入库列表</a>
							</li>

							<li>
								<a href="#store_out" role="tab" data-toggle="tab">通用辅料出库列表</a>
							</li>
							<!-- <li>
								<a href="#store_return" role="tab" data-toggle="tab">退货列表</a>
							</li> -->
							<li>
								<a href="#current_stock" role="tab" data-toggle="tab">通用辅料库位库存报表</a>
							</li>
						</ul>
						...
						<div class="tab-content auto_height">
							<div class="tab-pane active" id="store_in">
								<iframe id="store_inIframe" name="store_inIframe" border="0" furl="fuliaoin/index_common" > </iframe>

							</div>
							<div class="tab-pane" id="store_out">
								<iframe id="store_outIframe" name="store_outIframe" border="0" furl="fuliaoout/index_common" > </iframe>
							</div>
							<div class="tab-pane" id="current_stock">
								<iframe id="current_stockIframe" name="current_stockIframe" border="0" furl="fuliao_workspace/current_stock_common" > </iframe>
							</div>
						</div>
					</div>
	...
	<script type="text/javascript">
			/*设置当前选中的页*/
			var $a = $("#left li a[href='fuliao_workspace/commonfuliao_workspace']");
