			...
			<div id="main">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li>
							<a target="_blank" href="order/tablelist?orderId=<%=producingOrder.getOrderId()%>&tab=producingorder">订单表格</a>
						</li>
						<li class="active">
							生产单划价
						</li>
							...
							<form class="saveform">
									...
									<table class="table">
										<caption id="tablename">
											桐庐富伟针织厂生产单
													...
													<tr>
														<td>
															<table class="table table-responsive detailTb table-bordered" style="background-color: #737272;">
																<caption>
																	颜色及数量
																</caption>
																<thead>
																...
																<tbody>
																	...
																	<tr class="tr" data='<%=SerializeTool.serialize(detail)%>'>
																		...
																		<td class="int"><%=detail.getQuantity()%>
																		</td>
																		<td class="double">
																...
																<tbody>
																	<tr>
																		<td rowspan="7" width="50%">
																			<a href="/<%=producingOrder.getImg()%>" class="thumbnail"
																				target="_blank"> <img id="previewImg"
																					alt="200 x 100%" src="/<%=producingOrder.getImg_s()%>">
																			</a>
																		</td>
																		<td width="20%">
																			生产单位
								...
								.getFactoryId())%></td>
																	...
																	<tr>
																		...
																		<td><%=SystemCache.getCompanyName(producingOrder
										.getCompanyId())%></td>
																	</tr>
																	<tr>
																		<td>
