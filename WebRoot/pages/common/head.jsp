...
//	Boolean h_has_systeminfo= SystemCache.hasAuthority(session,"systeminfo");
	...
	Boolean producing_editprice = SystemCache.hasAuthority(session,"order/producing/editprice");//编辑生产单单价
%>
<html>
				...
				<ul class="menubar-ul">
					...
					<li class="li_dropdown">
						...
						<ul class="submenu">
							...
							<%} %>
							<%if(producing_editprice){ %>
							<li>
								<a href="producing_order/scan_edit">编辑生产单单价</a>
							</li>
							<%} %>
					...
					<li class="li_dropdown">
						...
						<ul class="submenu">
							...
							<%} %>
							<%if(h_has_yanchang_systemstatus){ %>
							<li>
								<a href="yanchang/systemstatus">当前验厂状态</a>
							</li>
							<%} %>
