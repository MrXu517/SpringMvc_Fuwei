			...
			<div id="main">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li>
							<a href="material_purchase_order/index">辅料采购单列表</a>
						</li>
						<li class="active">
							编辑辅料采购单
						</li>
																	...
																	<%
																		for (Company company : SystemCache.companylist) {
																			if (fuliaoPurchaseOrder.getCompanyId() != null
																					&& company.getId() == fuliaoPurchaseOrder
																							.getCompanyId()) {
																	%>
							...
							: fuliaoPurchaseOrder.getProductNumber()%>" />
																...
																<select class="form-control" name="customerId"
																	...
																	<%
																		for (Customer customer : SystemCache.customerlist) {
																			if (fuliaoPurchaseOrder.getCustomerId() != null
																					&& fuliaoPurchaseOrder.getCustomerId() == customer
																							.getId()) {
																	%>
															...
															<td class="center">
																<input type="text" name="name" id="name"
																	class="form-control"
																	value="<%=fuliaoPurchaseOrder.getName() == null ? ""
					: fuliaoPurchaseOrder.getName()%>" />
															</td>
														</tr>
													</table>
												</td>
