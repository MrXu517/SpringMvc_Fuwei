...
public class FuliaoOutNoticeDetailService extends BaseService {
	...
	public boolean addBatch(List<FuliaoOutNoticeDetail> detailList) throws Exception {
		String sql = "INSERT INTO tb_fuliaoout_notice_detail(fuliaoInOutNoticeId,fuliaoId,quantity,img,img_s,img_ss,color,size,batch,fuliaoTypeId,company_orderNumber,company_productNumber) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)";
