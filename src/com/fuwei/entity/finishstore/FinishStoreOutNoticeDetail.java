...
@Table("tb_finishstore_out_notice_detail")
public class FinishStoreOutNoticeDetail {
	@IdentityId
	private int id;
	private int finishStoreOutNoticeId;
	...
	public int getFinishStoreOutNoticeId() {
		return finishStoreOutNoticeId;
	}
	public void setFinishStoreOutNoticeId(int finishStoreOutNoticeId) {
