...
//成品退库
@Table("tb_finishstore_return")
public class FinishStoreReturn {
	@IdentityId
	private Integer id;
	...
	@Temporary
	private List<FinishStoreReturnDetail> detaillist ;
	...
	public List<FinishStoreReturnDetail> getDetaillist() {
		return detaillist;
	}

	public void setDetaillist(List<FinishStoreReturnDetail> detaillist) {
