...
public class StoreInOut {
	...
	private Integer factoryId;//领取工厂
	private String sign;//领取人签字
	
	
//	private Integer employee_id ;//经办人
	...
	public void setDetail_json(String detail_json) throws Exception {
		if(detail_json != null && !detail_json.equals("")){
			this.setDetaillist(SerializeTool.deserializeList(detail_json,StoreInOutDetail.class));
		}
...
//	}
	...
	public String createNumber() throws ParseException{
		if(this.in_out){//入库
			return DateTool.getYear2() + "SRK" + NumberUtil.appendZero(this.id, 4);
		}
		else{//出库
			return DateTool.getYear2() + "SCK" + NumberUtil.appendZero(this.id, 4);
		}
	}
