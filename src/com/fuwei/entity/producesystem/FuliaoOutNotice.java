...
@Table("tb_fuliaoout_notice")
public class FuliaoOutNotice {
	@IdentityId
	private int id;
	...
	@Temporary
	private List<FuliaoOutNoticeDetail> detaillist;
	...
	public List<FuliaoOutNoticeDetail> getDetaillist() {
		return detaillist;
	}
	public void setDetaillist(List<FuliaoOutNoticeDetail> detaillist) {
	...
	public String createNumber() throws ParseException{	
		return DateTool.getYear2() + "FCT" + NumberUtil.appendZero(this.id, 4);
