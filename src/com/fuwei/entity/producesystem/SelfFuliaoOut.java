...
@Table("tb_selffuliaoout")
public class SelfFuliaoOut {
	@IdentityId
	private int id;
	...
	private Integer receiver_employee;//领取辅料的人
	private Boolean is_cleaning;//是否是手动清库存单据 2016-4-9添加
	
	@Temporary
	private List<SelfFuliaoOutDetail> detaillist ;
	public int getId() {
		return id;
	}
	...
	public List<SelfFuliaoOutDetail> getDetaillist() {
		return detaillist;
	}
	public void setDetaillist(List<SelfFuliaoOutDetail> detaillist) {
		this.detaillist = detaillist;
	}
	public String createNumber() throws ParseException{	
		return DateTool.getYear2() + "ZC" + NumberUtil.appendZero(this.id%9999, 4);
	}
