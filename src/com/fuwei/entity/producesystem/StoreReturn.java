...
public class StoreReturn {
	...
	@Temporary
	private List<StoreReturnDetail> detaillist ;
	...
	public void setDetaillist(List<StoreReturnDetail> detaillist) {
	...
	public void setDetail_json(String detail_json) throws Exception {
		if(detail_json != null && !detail_json.equals("")){
			this.setDetaillist(SerializeTool.deserializeList(detail_json,StoreReturnDetail.class));
		}
