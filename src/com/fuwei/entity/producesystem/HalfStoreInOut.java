...
//半成品出入库
@Table("tb_half_store_in_out")
public class HalfStoreInOut {
	@IdentityId
	private Integer id;
...
//	private Integer employee_id ;//经办人，员工名，不是用户名
	...
	@Temporary
	private List<HalfStoreInOutDetail> detaillist ;
...
//		this.producing_order_number = producing_order_number;
//	}
//	public Integer getProducing_order_id() {
//		return producing_order_id;
//	}
//	public void setProducing_order_id(Integer producing_order_id) {
//		this.producing_order_id = producing_order_id;
//	}
...
//	}
	...
	public void setDetail_json(String detail_json) throws Exception {
		if(detail_json != null && !detail_json.equals("")){
			this.setDetaillist(SerializeTool.deserializeList(detail_json,HalfStoreInOutDetail.class));
		}
		
		this.detail_json = detail_json;
	}
	public List<HalfStoreInOutDetail> getDetaillist() {
		return detaillist;
	}
	public void setDetaillist(List<HalfStoreInOutDetail> detaillist) {
...
//	}
	...
	public String createNumber() throws ParseException{
		if(this.in_out){//入库
			return DateTool.getYear2() + "HRK" + NumberUtil.appendZero(this.id, 4);
		}
		else{//出库
			return DateTool.getYear2() + "HCK" + NumberUtil.appendZero(this.id, 4);
		}
	}
