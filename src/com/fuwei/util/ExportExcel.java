...
//						.getSampleId());
				...
				sheet.addCell(new Label(2, 6 + i, detail.getName(), content_center));
...
//	}
	...
	public final static String exportSampleDetailExcel(Sample sample,QuotePrice quotePrice,
		...
		try {
			...
			sheet.addCell(new Label(1, 3, SystemCache.getUserName(sample.getCreated_user()), sample_detail_content_center));
